...
<body>
    ...
    <?php
        ...
        if (isset($_POST['submit'])){
            ...
            $unique_photo_name = md5(time().rand()).$photo_name;
            move_uploaded_file($photo_tmp_name,'assets/media/img/'.$unique_photo_name);

            if (empty($name) || empty($me) || empty($pass) || empty($dob)||empty($gender)){
                $msg = validate('All fields are require','danger');
            }else{
                insert("INSERT INTO users (name,email,cell,password,dob,gender,photo)VALUES ('$name','$email','$cell','$pass_hash','$dob','$gender','$unique_photo_name')");
                $msg = validate('data insert successful','success');
            }
    ...
    <?php
        if (isset($_POST['login'])){
            ...
            if (empty($me) || empty($pass)){
                $msg = validate('Fields must not be empty');
            }else{
                $sql = "SELECT * FROM users WHERE email='$me'|| cell='$me'";
                ...
                if ($user_num>0){
                    if (password_verify($pass,$user_data['password']) ){
                        ...
                        $msg = validate('Wrong password');
                    }

                }else{
                    $msg = validate('Wrong email or mobile number');
                }
            }
        }
    ...
    <div style="width: 70%;margin: 50px auto 0px;" class="mess">
        <?php
        if (isset($msg)){
            echo $msg;
        }
							...
							<div class="log">
								<form action="" method="POST">
									<div class="form-group">
										<input name="me" class="form-control" type="text">
									</div>
									<div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input name="pass" class="form-control" type="text" placeholder="New password">
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group">
                            <img id="profile_image_loader" src="" alt="">
                            <input style="display: none;" name="photo" class="form-control-file" type="file" id="photo_load">
                            <label for="photo_load"><img style="width: 70px;" src="assets/media/img/photo-camera-icon-vector-21679737%20(1).jpg" alt=""></label>
                        </div>
                        <hr>
