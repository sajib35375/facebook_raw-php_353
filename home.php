...
if (isset($_POST['post'])){
    $post_name = $login_user['name'];
    $post_photo = $login_user['photo'];
    $content = $_POST['content'];

    $featured_photo = $_FILES['featured_photo']['name'];
    $featured_photo_tmp = $_FILES['featured_photo']['tmp_name'];

    $unique_photo_name = md5(time().rand()).$featured_photo;

    if (!empty($content)){
        insert("INSERT INTO posts (name,photo,content,featured_photo)VALUES('$post_name','$post_photo','$content','$unique_photo_name')");
        move_uploaded_file($featured_photo_tmp,'assets/media/img/'.$unique_photo_name);
    }
}
			...
			<div class="modal-content ">
				<div class="modal-body">
					...
					<div class="post-user-details clearfix">
						<img src="assets/media/img/<?php echo $login_user['photo']; ?>" alt="">
					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="upload clearfix shadow-sm">
                            ...
                            <input name="featured_photo" style="display: none;" type="file" id="post_id">
							<ul>
								<li><a href="#"><label for="post_id"><img src="assets/media/img/icons/p1 (2).png" alt=""></label></a></li>
				...
				<div class="col-md-4 clearfix">
					...
					<div class="notification-bar float-right">
						<ul>
                            ...
                            <li class="dropdown logout"><a data-toggle="dropdown" href="#"><i class="fas fa-caret-down"></i></a>
							...
							<div class="card shadow-sm">
								<div class="card-body">
									<div class="post-header clearfix">
										<img src="assets/media/img/<?php echo $all_data['photo']; ?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $all_data['name']; ?></a></h4>
											<p>12 mins <i class="fas fa-globe-americas"></i></p>
										</div>
										<a class="float-right" href="#"><i class="fas fa-ellipsis-h"></i></a>
									</div>
									<div class="post-content mt-2">
										<p><?php echo $all_data['content']; ?></p>
										<img src="assets/media/img/<?php echo $all_data['featured_photo']; ?>" alt="">
									</div>
									<hr>
